...
SELECT CAST(SUM(number_of_Casualties) AS decimal(10,2))*100 /(SELECT CAST( SUM( number_of_Casualties) AS decimal(10,2)) FROM [road_accidents sql]) AS PCFROM [road_accidents sql] WHERE accident_severity = 'Serious'
